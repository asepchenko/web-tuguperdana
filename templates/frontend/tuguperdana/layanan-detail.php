            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    <a class="page-scroll" href="tentang-kami.html">Tentang Kami</a>
                  </li>
                  <li>
                    <a class="page-scroll" href="layanan-kami.html">Layanan Kami</a>
                  </li>
                  <!--<li>
                    <a class="page-scroll" href="#team">Team</a>
                  </li> -->
                  <li>
                    <a class="page-scroll" href="portofolio.html">Portfolio</a>
                  </li>
                  <li>
          ...
          <div class="slider-content text-center">
            <div class="header-bottom">
              <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                <h1 class="title2">Detail Layanan Kami </h1>
              </div>
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <h2 class="title3">(Nama Layanan / Services Yang Dipilih)</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="recent-post">
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><a href="#">Perindustrian & Perdagangan.</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  <!-- start single post -->
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><a href="#"> Studi Penelitian dan Bantuan Teknis.</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  <!-- start single post -->
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><a href="#"> Pengembangan Pertanian dan Pedesaan.</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  <!-- start single post -->
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><a href="#">Jasa Analisis Engineering.</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  <!-- start single post -->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <article class="blog-post-wrapper">
                ...
                <div class="post-information">
                  <h2>Title Nama Service yang dipilih dari page layanan-kami</h2>
            ...
            <div class="footer-content">
              <div class="footer-head">
                <div class="footer-logo">
                  <h2><span>Tugu</span>Perdana</h2>
                </div>

                <p>Dengan mengemban misi menjadi salah satu Perusahaan yang  dapat berperan aktif dalam proses pembangunan bangsa, PT. TUGU PERDANA didirikan. Konsep terciptanya link and match antara kebutuhan industri dan perkembangan proses pembangunan bangsa Indonesia, menjadi salah satu acuan di dirikannya PT. TUGU PERDANA</p>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="footer-content">
              <div class="footer-head">
                <h4>Informasi</h4>
                <p>
                  Silahkan menghubungi kami melalui channel dibawah ini :
                </p>
                <div class="footer-contacts">
                  <p><span>Telp:</span> 021-56107157</p>
                  <p><span>Email:</span> info@tuguperdana.co.id</p>
                  <p><span>Working Hours:</span> 08:00 - 17:00 WIB</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="footer-content">
              <div class="footer-head">
                ...
                <div class="flicker-img">
                 <p>
                  ini nanti akan diisi maps location dari PT. Tugu perdana
                 </p>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="copyright text-center">
              <p>
                &copy; Copyright <strong>PT.TuguPerdana</strong>. All Rights Reserved
              </p>
            </div>
<!--            <div class="credits">
              <!--
