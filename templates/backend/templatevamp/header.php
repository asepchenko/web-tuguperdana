  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="dropdown <?=is_active_page_print('artikel','active');?>"><a href="<?=set_url('artikel/index');?>" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-file"></i><span>Post Konten</span> <b class="caret"></b></a> 
          <ul class="dropdown-menu">
            <li><a href="<?=set_url('artikel');?>">Daftar Konten</a></li>
            <li><a href="<?=set_url('artikel#tambah');?>">Tambah Konten</a></li>
        ...
        <li class="<?=is_active_page_print('home','active');?>"><a href="<?=base_url();?>" target="_blank"><i class="icon-home"></i><span>Beranda</span></a></li>        
      </ul>
    </div>
    <!-- /container --> 
  </div>
